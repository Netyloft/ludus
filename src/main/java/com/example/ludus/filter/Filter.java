package com.example.ludus.filter;

import com.example.ludus.filter.internal.Condition;
...
//       return conditions.stream().map(this::buildPredicate).collect(toList());
    ...
    private Predicate buildGreaterThanPredicateToCriteria(Condition condition,
                                                          Root root,
